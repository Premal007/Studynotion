...
//                     // If the link has a type and the user's account type does not match, skip rendering this link
...
//             {/* horizontal line create karva mate */}
...
//                 <button
//                     onClick={() =>
//                         //onclick par aa vadu modal open thai ne avse
...
//                 >
//                     {/* je button hse te mate aa text content che */}
...
//         {/* jo confirmationModal null hoy to te render nai thay nai to data pass thse etle e pramane render thse */}
...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="md:hidden text-white absolute left-7 top-3 cursor-pointer " onClick={() => dispatch(setOpenSideMenu(!openSideMenu))}>
        {
