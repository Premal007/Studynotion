...
export default function CourseInformationForm() {
  ...
  const [courseCategories, setCourseCategories] = useState([]) //dropdown ma set krva 
  ...
  useEffect(() => {
    ...
    if (editCourse) {
      ...
      //name apvu hoy foem jode link krv e : Backend ma je variable name apyu hoy te
