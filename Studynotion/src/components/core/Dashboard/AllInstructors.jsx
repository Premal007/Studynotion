        ...
        <Tbody>
          {
            ...
            <>
              ...
              :
              !allInstructorDetails ? <Td className='text-5xl py-5 bg-yellow-800 text-white text-center'>No Data Available</Td>
                :
                allInstructorDetails?.map((instructor) => (
                  ...
                  >
                      ...
                      <Td className="flex flex-1 gap-x-2">
                        ...
                        <div className="flex flex-col justify-between">
                          <p className="text-lg font-semibold text-richblack-5">
                            <div className='flex flex-col text-sm font-normal py-3 gap-1'>
                              <p className='text-xl font-bold capitalize'>{instructor.firstName + " " + instructor.lastName}</p>
                    ...
                    {instructor.courses.length ? (
                      <Tr className="flex gap-x-10 px-6 pb-5">
                        ...
                        <div className='grid grid-cols-5 gap-y-5'>
                          {instructor.courses.map((course) => (
                            <div className="flex flex-col text-white text-sm gap-2 px-2" key={course._id}>
                      ...
                      :
                      <div className="px-6 text-white mb-4">Not built any course</div>
                    }
                  </div>
