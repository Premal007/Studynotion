// import * as Icons from "react-icons/vsc"  // vsc thi start thata hoy te j icons import karva
...
//         {/* left side ma je vertical line che e mate */}
//       <span
...
export default function SidebarLink({ link, iconName }) {
  ...
  const handleClick = () => {
    ...
    if (openSideMenu && screenSize < 930) dispatch(setOpenSideMenu(false))
  }
