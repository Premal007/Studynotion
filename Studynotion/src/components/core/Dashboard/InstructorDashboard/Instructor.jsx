        ...
        {loading ? (
          ...
          <div>
            <div className="my-4 flex md:flex-row flex-col h-[600px] md:h-[450px] md:space-x-4 ">
              ...
              {/* Total Statistics */}
              <div className="flex md:mt-0 mx-auto mt-6 w-10/12 flex-col rounded-md bg-richblack-800 p-6">
            ...
            <div className="rounded-md bg-richblack-800 md:mt-0 mt-[230px] p-6">
              {/* Render 3 courses */}
